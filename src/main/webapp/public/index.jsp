			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a href="<%=request.getContextPath()%>/student/list"><i class="icon-list-alt"></i><span class="hidden-tablet"> 管理员</span></a></li>

						<li><a href="<%=request.getContextPath()%>/student/list"><i class="icon-list-alt"></i><span class="hidden-tablet"> 学生</span></a></li>
						<li><a href="<%=request.getContextPath()%>/teacher/list"><i class="icon-font"></i><span class="hidden-tablet"> 老师</span></a></li>
						<li><a href="<%=request.getContextPath()%>/subject/list"><i class="icon-align-justify"></i><span class="hidden-tablet"> 课程</span></a></li>
						<li><a href="<%=request.getContextPath()%>/qsas/list"><i class="icon-picture"></i><span class="hidden-tablet"> 反馈与解答</span></a></li>
