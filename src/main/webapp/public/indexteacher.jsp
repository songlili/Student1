					...
					<ul class="nav pull-right">
						...
						<li class="dropdown">
							...
							<ul class="dropdown-menu">
								...
								<li><a href="<%=request.getContextPath()%>/teacher/login.html"><i class="halflings-icon off"></i> Logout</a></li>
							</ul>
						</li>
						<!-- end: User Dropdown -->
					</ul>
			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a href="<%=request.getContextPath()%>/viewteacher/teacher/list"><i class="icon-font"></i><span class="hidden-tablet"> 老师</span></a></li>
						<li><a href="<%=request.getContextPath()%>/viewteacher/subject/list"><i class="icon-align-justify"></i><span class="hidden-tablet"> 课程</span></a></li>
						<li><a href="<%=request.getContextPath()%>/viewteacher/qsas/list"><i class="icon-picture"></i><span class="hidden-tablet"> 反馈与解答</span></a></li>
